./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY.root files_allTES/ZTTall.root ZTT ZTT 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY.root files_allTES/ZLall.root ZL ZL 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY.root files_allTES/ZJall.root ZJ ZJ 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY1.root files_allTES/ZTT1.root ZTT ZTT 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY1.root files_allTES/ZL1.root ZL ZL 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY1.root files_allTES/ZJ1.root ZJ ZJ 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY2.root files_allTES/ZTT2.root ZTT ZTT 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY2.root files_allTES/ZL2.root ZL ZL 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY2.root files_allTES/ZJ2.root ZJ ZJ 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY3.root files_allTES/ZTT3.root ZTT ZTT 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY3.root files_allTES/ZL3.root ZL ZL 1
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY3.root files_allTES/ZJ3.root ZJ ZJ 1
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY4.root files_allTES/ZTT4.root ZTT ZTT 1
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY4.root files_allTES/ZL4.root ZL ZL 1 
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY4.root files_allTES/ZJ4.root ZJ ZJ 1
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DYlow.root files_allTES/DYlow.root DYlow ZTT 1
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY1low.root files_allTES/DY1low.root DY1low ZTT 1
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/DY2low.root files_allTES/DY2low.root DY2low ZTT 1
...
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/WHbbtt40.root files_allTES/WHbbtt40.root WHbbtt40 WHbbtt40 1
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_15nov/ZHbbtt40.root files_allTES/ZHbbtt40.root ZHbbtt40 ZHbbtt40 1
hadd -f files_allTES/signal.root files_allTES/bbtt15.root files_allTES/bbtt20.root files_allTES/bbtt25.root files_allTES/bbtt30.root files_allTES/bbtt35.root files_allTES/bbtt40.root files_allTES/bbtt45.root files_allTES/bbtt50.root files_allTES/bbtt55.root files_allTES/bbtt60.root files_allTES/VBFbbtt20.root files_allTES/VBFbbtt40.root files_allTES/VBFbbtt60.root files_allTES/WHbbtt40.root files_allTES/ZHbbtt40.root 
...
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_11august/ZH_LLBB.root files_allTES/ZH_LLBB.root ZH_LLBB ZH_hbb125 1
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_11august/WminusH_LBB.root files_allTES/WminusH_LBB.root WminusH_LBB WH_hbb125 1
./FinalSelection2D_relaxed.exe /data/ccaillol/BBTT_et_11august/WplusH_LBB.root files_allTES/WplusH_LBB.root WplusH_LBB WH_hbb125 1
hadd -f files_allTES/SMH.root files_allTES/ggH125.root files_allTES/ggHWW125.root files_allTES/VBFH125.root files_allTES/VBFHWW125.root files_allTES/ZH125.root files_allTES/ZHWW125.root files_allTES/WplusH125.root files_allTES/WplusHWW125.root files_allTES/WminusH125.root files_allTES/WminusHWW125.root files_allTES/ttHnonbb.root files_allTES/ZH_LLBB.root files_allTES/WminusH_LBB.root files_allTES/WplusH_LBB.root 


python Create_QCD_2Drelaxed.py --scale allTES
python Create_fake.py --scale allTES
python Create_VBF.py --scale allTES
python Create_VH.py --scale allTES

hadd -f final_up.root files_allTES/W.root files_allTES/ZJ.root files_allTES/ZL.root files_allTES/ZTT.root files_allTES/TTT.root files_allTES/TTJ.root files_allTES/QCD.root files_allTES/VV.root files_allTES/signal.root files_allTES/ST.root files_allTES/Fake.root files_allTES/SMH.root files_allTES/VBFsignal.root files_allTES/TTL.root files_allTES/VHsignal.root
